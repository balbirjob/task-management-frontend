  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <br/>
        <input  className="titin" type="text" value={title} onChange={(e) => setTitle(e.target.value)} required />
        <br/>
        ...
        <br/>
        <label className='chekli'>Checklist</label>
        {checklist.map(item => (
        ...
        <button className="add-checklist-btn" onClick={handleAddChecklistItem}>+ Add new </button>
        <br/>
        <label className='datel'>Due Date</label>
